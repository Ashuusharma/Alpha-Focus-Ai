    ...
    <div className="min-h-screen bg-[#F4F1EB] text-[#1E4D3A]">
      <main className="mx-auto w-full max-w-7xl space-y-14 px-6 py-16 md:space-y-16 md:py-20">
        <section className="grid items-center gap-10 lg:grid-cols-2">
          <div>
            <p className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#A9CBB7] bg-[#E8E3DA] px-3 py-1 text-xs font-semibold uppercase tracking-[0.14em] text-[#2F6F57]">
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-[#2F6F57] md:text-lg">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <button onClick={() => onNavigate("/assessment")} className="rounded-xl border border-[#D9D2C7] bg-white px-6 py-3 text-sm font-semibold text-[#2F6F57] shadow-[0_8px_20px_rgba(0,0,0,0.04)]">
                Answer Questions
              </button>
              <button onClick={onLogin} className="rounded-xl border border-[#D9D2C7] bg-[#F4F1EB] px-6 py-3 text-sm font-semibold text-[#2F6F57]">
                Sign In
              </button>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl bg-white p-3">
                ...
                <svg viewBox="0 0 320 90" className="mt-2 h-20 w-full" role="img" aria-label="weekly trend">
                  <polyline fill="none" stroke="#2F6F57" strokeWidth="2" points="6,72 52,68 98,63 144,58 190,51 236,45 282,38 314,32" />
                </svg>
              </div>
            </div>
          </div>
        ...
        <section className="grid gap-3 rounded-2xl border border-[#E2DDD4] bg-white p-4 md:grid-cols-3">
          {[
            "Nature-Informed Dermatology",
            "Clinical-Grade AI Guidance",
            "Structured, Measurable Progress",
          ].map((item) => (
            <div key={item} className="inline-flex items-center gap-2 rounded-xl bg-[#F7F4EE] px-3 py-2 text-sm text-[#2F6F57]">
        ...
        <section className="rounded-2xl border border-[#E2DDD4] bg-white p-6 shadow-[0_8px_20px_rgba(0,0,0,0.04)]">
          <h2 className="text-2xl">How It Works</h2>
          <div className="mt-5 grid gap-4 md:grid-cols-3">
            <div className="rounded-xl bg-[#F7F4EE] p-4">
              <Upload className="h-5 w-5 text-[#2F6F57]" />
              <p className="mt-2 font-semibold">Scan</p>
              <p className="text-sm text-[#2F6F57]">Upload a clear face or scalp image for baseline assessment.</p>
            </div>
            <div className="rounded-xl bg-[#F7F4EE] p-4">
              <Stethoscope className="h-5 w-5 text-[#2F6F57]" />
              <p className="mt-2 font-semibold">Clinical Review</p>
              <p className="text-sm text-[#2F6F57]">AI evaluates concern severity, confidence, and contributing factors.</p>
            </div>
            <div className="rounded-xl bg-[#F7F4EE] p-4">
              <FileText className="h-5 w-5 text-[#2F6F57]" />
              <p className="mt-2 font-semibold">Personalized Protocol</p>
              <p className="text-sm text-[#2F6F57]">Receive a structured plan with routine, ingredients, and follow-up.</p>
            </div>
          </div>
        </section>
        ...
        <section className="grid gap-4 md:grid-cols-4">
          {[
            ...
            <div key={label} className="rounded-xl border border-[#E2DDD4] bg-white p-4 shadow-[0_4px_14px_rgba(0,0,0,0.03)]">
        ...
        <section className="rounded-2xl border border-[#E2DDD4] bg-white p-6 shadow-[0_8px_20px_rgba(0,0,0,0.04)]">
          ...
          <div className="mt-4 overflow-x-auto rounded-xl border border-[#E2DDD4]">
            <table className="min-w-full text-sm">
              ...
              <tbody>
                <tr className="border-t border-[#E2DDD4]">
                  <td className="px-4 py-3">AF-10384</td>
                  <td className="px-4 py-3">Scalp Barrier Stress</td>
                  <td className="px-4 py-3"><span className="rounded-full border border-[#E0CE97] bg-[#F4EED7] px-2.5 py-1 text-xs font-semibold text-[#8C6A5A]">Moderate</span></td>
                  <td className="px-4 py-3">82%</td>
                </tr>
              </tbody>
            </table>
          </div>
          <button onClick={() => onNavigate("/assessment")} className="mt-4 rounded-xl border border-[#D9D2C7] bg-[#F4F1EB] px-5 py-2.5 text-sm font-semibold text-[#2F6F57]">Answer Questions</button>
        </section>

        <section className="rounded-2xl border border-[#E2DDD4] bg-white p-6 shadow-[0_8px_20px_rgba(0,0,0,0.04)]">
          <h2 className="text-2xl">Transformation Journey</h2>
          <div className="mt-4 grid gap-3 md:grid-cols-3">
            <div className="rounded-xl bg-[#F7F4EE] p-4"><p className="font-semibold">Week 1–2</p><p className="text-sm text-[#2F6F57]">Stabilization</p></div>
            <div className="rounded-xl bg-[#F7F4EE] p-4"><p className="font-semibold">Week 3–6</p><p className="text-sm text-[#2F6F57]">Visible Improvement</p></div>
            <div className="rounded-xl bg-[#F7F4EE] p-4"><p className="font-semibold">Maintenance</p><p className="text-sm text-[#2F6F57]">Strengthening</p></div>
          </div>
        </section>

        <section className="rounded-2xl border border-[#E2DDD4] bg-white p-6 shadow-[0_8px_20px_rgba(0,0,0,0.04)]">
          <h2 className="text-2xl">Adherence & Outcomes</h2>
          <p className="mt-2 text-[#2F6F57]">Adherence improves measurable outcomes. Consistency across routine, hydration, and sleep drives stronger recovery trends.</p>
        </section>

        <section className="rounded-2xl border border-[#E2DDD4] bg-white p-6 shadow-[0_8px_20px_rgba(0,0,0,0.04)]">
          <h2 className="text-2xl">Privacy & Safety</h2>
          <div className="mt-4 grid gap-2 text-sm text-[#2F6F57]">
        ...
        <section className="rounded-2xl border border-[#E2DDD4] bg-white p-8 text-center shadow-[0_10px_24px_rgba(0,0,0,0.05)]">
