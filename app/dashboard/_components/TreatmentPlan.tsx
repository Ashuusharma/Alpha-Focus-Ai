...
import TaskCard, { type TaskRuntime, type TaskWindowStatus } from "./TaskCard";
...
export default function TreatmentPlan({
  ...
  if (!selectedCategory || !template || !execution) {
    return (
      <section className="af-card border-none bg-white p-8 shadow-xl/5">
  ...
  return (
    <section className="af-card border-none bg-white p-4 md:p-8 shadow-sm flex flex-col relative" id="daily-execution-engine">
      ...
      <div className="relative mt-16 flex flex-col items-center gap-6 overflow-hidden rounded-[var(--radius-card)] bg-gradient-to-br from-[var(--ink)] via-[var(--ink)] to-[var(--ink)] p-8 text-white shadow-xl">
