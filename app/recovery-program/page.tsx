    ...
    return (
      <main className="af-page px-4 py-6 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <p className="text-sm text-[var(--ink-soft)]">Loading recovery planner...</p>
        </div>
      </main>
    );
  }
        ...
        <section className="af-page-hero p-6 md:p-8">
          <div className="relative z-10 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-3 text-sm leading-7 text-[var(--ink-soft)]">View the complete protocol timeline, stay anchored to your current phase, and switch categories without leaving the premium dashboard shell.</p>
            </div>
            <div className="flex w-full flex-col gap-3 lg:max-w-sm">
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="af-stat-tile">
                  <p className="text-[11px] font-black uppercase tracking-[0.16em] text-[var(--ink-soft)]">Current day</p>
                  <p className="mt-2 text-3xl font-bold text-[var(--ink)]">{programDay}</p>
                  <p className="mt-1 text-xs text-[var(--ink-soft)]">Of 30-day protocol</p>
                </div>
                <div className="af-stat-tile">
                  <p className="text-[11px] font-black uppercase tracking-[0.16em] text-[var(--ink-soft)]">Current phase</p>
                  <p className="mt-2 text-base font-semibold text-[var(--ink)]">{phaseName}</p>
                  <p className="mt-1 text-xs text-[var(--ink-soft)]">{categoryLabel}</p>
                </div>
              </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="af-card-secondary p-4">
            <div className="flex items-center gap-2 text-[var(--ink)]">
              <CalendarRange className="h-4 w-4 text-[var(--accent-blue)]" />
              <span className="font-semibold">Protocol timing</span>
            </div>
            <p className="mt-2 text-sm text-[var(--ink-soft)]">Use this screen when you need the full day-by-day view rather than the dashboard mission summary.</p>
          </div>
          <div className="af-card-secondary p-4">
            <div className="flex items-center gap-2 text-[var(--ink)]">
            ...
            <p className="mt-2 text-sm text-[var(--ink-soft)]">Switch categories here to audit how each track maps into its own execution plan.</p>
          </div>
          <div className="af-card-secondary p-4">
            <div className="flex items-center gap-2 text-[var(--ink)]">
              <Sparkles className="h-4 w-4 text-[var(--accent-blue)]" />
            ...
            <p className="mt-2 text-sm text-[var(--ink-soft)]">Keep this page focused on execution structure, not secondary analytics already covered on the dashboard.</p>
          </div>
        </div>
