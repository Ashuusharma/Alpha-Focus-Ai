...
export default function CartPage() {
  ...
  return (
    <div className="af-page-shell min-h-screen px-4 py-8 text-[#1d1d1f] md:px-6 md:py-10">
      <div className="mx-auto max-w-5xl af-section-grid">
        <button onClick={() => router.back()} className="mb-5 inline-flex items-center gap-2 text-[#6e6e73] hover:text-[#1d1d1f]">
          ...
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="af-card-secondary p-5 md:min-w-[280px]">
              <div className="mb-4 flex items-center gap-3">
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#eef5ff] text-[#0071e3]">
                  <ShoppingBag className="h-7 w-7" />
                </div>
                <div>
                  <p className="text-xs font-black uppercase tracking-[0.16em] text-[#6e6e73]">Purchase flow</p>
                  <p className="mt-1 text-lg font-bold text-[#1d1d1f]">Cart to checkout</p>
                </div>
              </div>
        ...
        <section className="grid gap-4 md:grid-cols-3">
          <div className="af-card-secondary p-5">
            <div className="mb-3 flex items-center gap-3">
              ...
              <p className="text-sm font-bold text-[#1d1d1f]">Secure checkout</p>
            </div>
            <p className="text-sm leading-6 text-[#6e6e73]">Encrypted checkout with guarantee and trust messaging carried through the purchase step.</p>
          </div>
          <div className="af-card-secondary p-5">
            <div className="mb-3 flex items-center gap-3">
              <Sparkles className="h-5 w-5 text-[#A46A2D]" />
              <p className="text-sm font-bold text-[#1d1d1f]">Routine-linked buying</p>
            </div>
            <p className="text-sm leading-6 text-[#6e6e73]">The purchase flow is tied to your regimen, not generic catalog browsing.</p>
          </div>
          <div className="af-card-secondary p-5">
            <div className="mb-3 flex items-center gap-3">
              <ArrowRight className="h-5 w-5 text-[#B16035]" />
              <p className="text-sm font-bold text-[#1d1d1f]">Next action</p>
            </div>
            <p className="text-sm leading-6 text-[#6e6e73]">Continue to checkout for payment, coupons, active rewards, and shipping selection.</p>
          </div>
        </section>
      </div>
    </div>
