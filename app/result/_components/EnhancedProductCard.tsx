...
export default function EnhancedProductCard({
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden rounded-[1.8rem] border border-[#d9d9de] bg-white transition-all shadow-[0_10px_26px_rgba(17,17,17,0.04)] hover:-translate-y-1 hover:shadow-[0_18px_38px_rgba(17,17,17,0.08)] group">
      <div className="flex items-start justify-between border-b border-[#eee4d7] bg-[linear-gradient(180deg,#fffaf3_0%,#f5ecdf_100%)] p-5">
        <div className="flex-1">
          <h4 className="text-lg font-black text-[#111] group-hover:text-[#0071e3] transition-colors">
            {product.name}
          </h4>
        ...
        {/* Badge */}
        {product.badge && (
          <div className="ml-3 whitespace-nowrap rounded-full border border-[#d9d9de] bg-[#eef5ff] px-3 py-1 text-xs font-black text-[#0071e3] shadow-sm">
            {product.badge === "Best Seller" && "Top Seller"}
      ...
      <div className="p-5 flex-1 flex flex-col gap-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium text-[#6e6e73]">4.8 (120 reviews)</span>
        </div>

        <div className="flex flex-wrap gap-2">
          <span className="rounded-full border border-[#d9d9de] bg-[#E8F4EE] px-3 py-1 text-[11px] font-black uppercase tracking-[0.14em] text-[#0071e3]">Recommended by experts</span>
          <span className="rounded-full border border-[#d9d9de] bg-[#FFF8EF] px-3 py-1 text-[11px] font-black uppercase tracking-[0.14em] text-[#A46A2D]">Used by 10k+ users</span>
        </div>

        <div className="space-y-2 mb-2">
           <p className="text-xs font-black uppercase tracking-[0.16em] text-[#6e6e73]">Key Benefits</p>
           <div className="flex flex-wrap gap-2">
        ...
        {product.why ? (
          <div className="rounded-2xl border border-[#E6DED0] bg-[#FBF7F0] px-4 py-3">
            <div className="flex items-start gap-2">
              <ShieldCheck className="mt-0.5 h-4 w-4 text-[#0071e3]" />
              <div>
                <p className="text-xs font-black uppercase tracking-[0.16em] text-[#6e6e73]">Why this works</p>
        ...
        {(product.usage || product.frequency) ? (
          <div className="rounded-2xl border border-[#E6DED0] bg-white px-4 py-3">
            <div className="flex items-start gap-2">
              <Clock3 className="mt-0.5 h-4 w-4 text-[#6e6e73]" />
              <div className="space-y-1 text-sm text-[#4F4A43]">
                <p className="text-xs font-black uppercase tracking-[0.16em] text-[#6e6e73]">How to use</p>
                {product.usage ? <p>{product.usage}</p> : null}
                {product.frequency ? <p className="text-[#6e6e73]">Expected timeline: {product.frequency}</p> : null}
              </div>
            </div>
          </div>
        ) : null}
        ...
        <div className="mt-auto border-t border-[#eee4d7] pt-4">
          <div className="flex items-center justify-between gap-3">
            ...
            {markedOwned ? (
              <span className="rounded-full border border-[#d9d9de] bg-[#eef5ff] px-3 py-1 text-xs font-black text-[#0071e3]">
          ...
          <div className="mt-4 grid gap-2 sm:grid-cols-2">
            <button
              ...
              className={`
                ...
                ${
                  isAdded
                    ? "border border-[#d9d9de] bg-[#eef5ff] text-[#0071e3] hover:bg-[#dce9df]"
                    : "bg-[#0071e3] text-white shadow-[0_14px_28px_rgba(47,111,87,0.18)] hover:bg-[#005bbf]"
                }
              `}
            >
              {isAdded ? (
            ...
            <button
              ...
              className={`flex items-center justify-center gap-2 rounded-xl border px-6 py-2.5 font-semibold transition-all duration-300 ${markedOwned ? "border-[#d9d9de] bg-[#eef5ff] text-[#0071e3]" : "border-[#d9d9de] bg-[#FBF8F3] text-[#5F5A51] hover:bg-[#F4EEE4]"}`}
            >
